    ...
    <>
      ...
      <div className={styles.skills}>
        <div className={styles.skills1}>
          ...
          <a href="https://app.hackthebox.com/profile/171965">
            <div className={styles.hackthebox}></div>
          </a>
        </div>
        <div className={styles.skills2}>
          <div style={{ color: "#8400ff" }}>BugCrowd ~ Profile</div>
          <a href="https://bugcrowd.com/MShehryaarK">
            <div className={styles.bugcrowd}></div>
          </a>
        </div>
        <div className={styles.skills3}>
          <div style={{ color: "#8400ff" }}>Medium ~ Report</div>
          <a href="https://1ogic.medium.com">
